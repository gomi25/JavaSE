 ...
 * 		default		- 같은 패키지에서 접근 가능  ※ default는 아무것도 안 적는 것 
...
public class AccessModifier {
	...
	public static void main(String[] args) {
		Car car1 = new Car();	// ctrl + space 눌러서 찾아서 클릭 -> 상단에 import 키워드 생김
		car1.model = "제네시스 GV80";
		// car1.color = "black";	// protected 다른 패키지 접근 불가!
		// car1.year = "2023";		// default 다른 패키지 접근 불가!
		// car1.brand = "Hyundai";	// private 다른 클래스 접근 불가!

	CafeLatte latte1 = new CafeLatte();		// 같은 패키지는 import 안 해도 됨
	latte1.bean = "콜롬비아";
	latte1.brand = "빽다방";
	latte1.water = "480ml";
	// latte1.milk = "300ml";	// private 다른 클래스 접근 불가!
